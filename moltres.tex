...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=.7\textwidth]{moltres-decay-power}
    \caption{Power output during
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=.7\textwidth]{decay-temp}
...
assumption. Moltres required ad hoc adjustments to the uniform turbulent
viscosity assumption to reproduce the trends observed in the PoliMi and TU
Delft models.
