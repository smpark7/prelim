...
simulation tools with \gls{MSRE} experimental data by inclusion in the \gls{IRPhEP} handbook.
...
% Add MSR control rod lit review
...
constraints from legacy code, and simplifying assumptions to balance computational costs. Reactor
software developers 
