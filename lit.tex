...
\textit{tight coupling schemes} to couple the neutronics and thermal-hydraulics governing equations
to capture the strong multiphysics interactions in transient \gls{MSR} simulations accurately
without resorting to very small time-steps \cite{aufiero_development_2014}. Tightly coupled
...
model when using fixed point iterations. Conversely, proven
...
next subsection reviews existing \gls{MSR} multiphysics software and their applications.
...
robertson_conceptual_1971}. While these reactors have control rods, the rods are used in
