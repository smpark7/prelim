...
, which represent most turbulence models in use today
\cite{rodi_turbulence_2017}, operate on the eddy viscosity hypothesis which
states that the Reynolds stresses in the \gls{RANS} equations are given by:
%
\begin{align}
...
The various \gls{RANS}-based models mainly differ in their approach towards
...
for separated flows \cite{wilcox_turbulence_2006}. Investigations with
...
models became the most widely used turbulence model in the late 20th century
...
\subsection{$k$-$\tau$ Turbulence Model}
