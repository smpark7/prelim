...
in the coolant for \gls{MSR} modeling. Dubbed \textit{DYN3D-MSR}, the code also contains the FLOCAL
...
Another \gls{MSR} simulation approach involves developing inherently
...
\cite{zanetti_geometric_2015}. Other than the \gls{MSRE}, they
also modeled the \gls{MSFR} in a later publication which also featured \gls{TUD}'s
DALTON-HEAT coupled multiphysics tool \cite{fiorina_modelling_2014}.
...
framework facilitates multiphysics coupling with MOOSE-based applications for other physics
...
MOOSE-based application for advanced reactor \gls{TH} modeling, to
...
The proposed work aims to continue Moltres development for
