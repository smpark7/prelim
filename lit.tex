...
\section{MSR Multiphysics Simulation Tools}
...
capability from \gls{PSI} \cite{fiorina_creation_2018}. Finally, within the
modular MOOSE finite element framework, \gls{MSR} simulation tools include
Moltres
\cite{lindsay_introduction_2018}, the subject of this work, and Rattlesnake
\cite{wang_rattlesnake_2021}, both of which can couple to MOOSE's built-in
incompressible flow physics module. Rattlesnake supports high-fidelity
$S_N$ discrete ordinates and $P_N$ spherical harmonics angular discretization
schemes for solving the transport equations of various types of neutral
particles, including neutrons. 

solves the transport equation
for various types of neutral particles, including neutrons. It features 

Rattlesnake is primarily a radiation
...
fully coupled solves. Similarly, Moltres benefits from the highly-integrated
cross compatibility within the ecosystem of MOOSE-based applications.

Thus, MOOSE-based applications 
