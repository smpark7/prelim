...
This section describes specific modeling approach for
...
}, I ran the benchmark cases on a uniformly-spaced mesh consisting
...
I performed all eigenvalue calculations in Steps 0.2, 1.1, 1.2, 1.3, and 1.4
...
For the time-dependent cases in Step 2.1, I employed fully coupling with
a second-order implicit Backward Differential Formula (BDF2) time-stepping
scheme. For each driving frequency in the heat transfer coefficient, I set the
