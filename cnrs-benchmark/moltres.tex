...
\begin{align}
    ...
    \phi_{g'} + \chi^d_g \sum^I_i \lambda_i C_i \label{eq:cnrs-neut} \\
    %
...
The last two terms in Equation \ref{eq:cnrs-dnp} represent the advection and
...
\begin{align}
    ...
    \label{eq:cnrs-momentum}
    \shortintertext{and}
    \nabla \cdot \vec{u} =& 0
    \label{eq:cnrs-divergence}
    \shortintertext{where}
    p =& \text{ pressure,} \nonumber \\
